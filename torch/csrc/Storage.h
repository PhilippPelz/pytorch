...
#define THPZDoubleStorage_Check(obj)                                           \
  PyObject_IsInstance(obj, THPZDoubleStorageClass)
#define THPZFloatStorage_Check(obj)                                            \
  PyObject_IsInstance(obj, THPZFloatStorageClass)
#define THPHalfStorage_Check(obj) PyObject_IsInstance(obj, THPFloatStorageClass)
#define THPLongStorage_Check(obj) PyObject_IsInstance(obj, THPLongStorageClass)
#define THPIntStorage_Check(obj) PyObject_IsInstance(obj, THPIntStorageClass)
#define THPShortStorage_Check(obj)                                             \
  PyObject_IsInstance(obj, THPShortStorageClass)
#define THPCharStorage_Check(obj) PyObject_IsInstance(obj, THPCharStorageClass)
#define THPByteStorage_Check(obj) PyObject_IsInstance(obj, THPByteStorageClass)

#define THPDoubleStorage_CData(obj) (obj)->cdata
#define THPFloatStorage_CData(obj) (obj)->cdata
#define THPZDoubleStorage_CData(obj) (obj)->cdata
#define THPZFloatStorage_CData(obj) (obj)->cdata
