...
static std::unordered_map<std::string, at::ScalarType> attype_names = {
    {"Float", at::kFloat},     {"Double", at::kDouble}, {"ZFloat", at::kZFloat},
    {"ZDouble", at::kZDouble}, {"Half", at::kHalf},     {"Byte", at::kByte},
    {"Char", at::kChar},       {"Short", at::kShort},   {"Int", at::kInt},
    {"Long", at::kLong},
};
...
at::Tensor createTensor(PyObject *data) {
  ...
  return tensor_type->unsafeTensorFromTH(
      tensor, true); // Calls retain on underlying TH Tensor
}
