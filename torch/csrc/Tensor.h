...
#define THPZDoubleTensor_Check(obj)                                            \
  PyObject_IsInstance(obj, THPZDoubleTensorClass)
#define THPZFloatTensor_Check(obj)                                             \
  PyObject_IsInstance(obj, THPZFloatTensorClass)
...
#define THPZDoubleTensor_CData(obj) (obj)->cdata
#define THPZFloatTensor_CData(obj) (obj)->cdata
...
#define THPTensor_stateless_(NAME)                                             \
  TH_CONCAT_4(THP, Real, Tensor_stateless_, NAME)
#endif
...
#define THSPZDoubleTensor_Check(obj)                                           \
  PyObject_IsInstance(obj, THSPZDoubleTensorClass)
#define THSPZFloatTensor_Check(obj)                                            \
  PyObject_IsInstance(obj, THSPZFloatTensorClass)
...
#define THSPZDoubleTensor_CData(obj) (obj)->cdata
#define THSPZFloatTensor_CData(obj) (obj)->cdata
...
#define THSPTensor_stateless_(NAME)                                            \
  TH_CONCAT_4(THSP, Real, Tensor_stateless_, NAME)
#endif
