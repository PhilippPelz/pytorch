...
#define ASSERT_NOT_NULL(ptr)                                                   \
  ...
  ASSERT_NOT_NULL(tensor_classes = PyObject_GetAttrString(
                      torch_module, (char *)"_tensor_classes"));
...
#define INIT_STATELESS(type)                                                   \
  stateless = PyObject_Call(                                                   \
      (PyObject *)&TH_CONCAT_2(type, TensorStatelessType), arg, NULL);         \
  if (!stateless) {                                                            \
  ...
  if (PyObject_SetAttrString(TH_CONCAT_3(THP, type, TensorClass),              \
    ...
    THPUtils_setError(                                                         \
        "stateless method initialization error (on assignment)");              \
  }
...
static PyMethodDef TorchMethods[] = {
    ...
    {"multinomial", (PyCFunction)THPModule_multinomial,
     METH_VARARGS | METH_KEYWORDS, NULL},
    {"uniform", (PyCFunction)THPModule_uniform, METH_VARARGS | METH_KEYWORDS,
     NULL},
    {"normal", (PyCFunction)THPModule_normal, METH_VARARGS | METH_KEYWORDS,
     NULL},
    {"cauchy", (PyCFunction)THPModule_cauchy, METH_VARARGS | METH_KEYWORDS,
     NULL},
    {"log_normal", (PyCFunction)THPModule_log_normal,
     METH_VARARGS | METH_KEYWORDS, NULL},
    {"random", (PyCFunction)THPModule_random, METH_VARARGS | METH_KEYWORDS,
     NULL},
...
bool THCSPZDoubleTensor_init(PyObject *module);
bool THCSPZFloatTensor_init(PyObject *module);
