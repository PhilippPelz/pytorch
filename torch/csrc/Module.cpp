...
#define ASSERT_NOT_NULL(ptr)                                                   \
  if (!(ptr)) {                                                                \
    THPUtils_setError("couldn't load classes");                                \
    return false;                                                              \
  }
  ...
  if (!THPDoubleTensor_postInit(torch_module))
    return false;
  if (!THPFloatTensor_postInit(torch_module))
    return false;
  if (!THPZDoubleTensor_postInit(torch_module))
    return false;
  if (!THPZFloatTensor_postInit(torch_module))
    return false;
  if (!THPHalfTensor_postInit(torch_module))
    return false;
  if (!THPLongTensor_postInit(torch_module))
    return false;
  if (!THPIntTensor_postInit(torch_module))
    return false;
  if (!THPShortTensor_postInit(torch_module))
    return false;
  if (!THPCharTensor_postInit(torch_module))
    return false;
  ...
  ASSERT_NOT_NULL(THPFloatStorageClass = PyObject_GetAttrString(
                      torch_module, (char *)"FloatStorage"));
  ASSERT_NOT_NULL(THPZDoubleStorageClass = PyObject_GetAttrString(
                      torch_module, (char *)"ZDoubleStorage"));
  ASSERT_NOT_NULL(THPZFloatStorageClass = PyObject_GetAttrString(
                      torch_module, (char *)"ZFloatStorage"));
  ASSERT_NOT_NULL(THPHalfStorageClass = PyObject_GetAttrString(
                      torch_module, (char *)"HalfStorage"));
  ASSERT_NOT_NULL(THPLongStorageClass = PyObject_GetAttrString(
                      torch_module, (char *)"LongStorage"));
  ASSERT_NOT_NULL(THPIntStorageClass = PyObject_GetAttrString(
                      torch_module, (char *)"IntStorage"));
  ASSERT_NOT_NULL(THPShortStorageClass = PyObject_GetAttrString(
                      torch_module, (char *)"ShortStorage"));
  ASSERT_NOT_NULL(THPCharStorageClass = PyObject_GetAttrString(
...
#define INIT_STATELESS(type)                                                   \
  stateless = PyObject_CallFunctionObjArgs(                                    \
      (PyObject *)&TH_CONCAT_2(type, TensorStatelessType), NULL);              \
  if (!stateless) {                                                            \
    return false;                                                              \
  }                                                                            \
  if (PyObject_SetAttrString(TH_CONCAT_3(THP, type, TensorClass),              \
                             THP_STATELESS_ATTRIBUTE_NAME, stateless) == -1) { \
    return false;                                                              \
  }
  PyObject *stateless;
...
PyObject *THPModule_fromNumpy(PyObject *_unused, PyObject *array) {
  ...
  if (type == NPY_DOUBLE) {
    ...
    return PyObject_CallFunctionObjArgs(THPZDoubleTensorClass, array, NULL);
  } else if (type == NPY_CFLOAT) {
    return PyObject_CallFunctionObjArgs(THPZFloatTensorClass, array, NULL);
  ...
  THPUtils_setError(
      "can't convert a given np.ndarray to a tensor - it has an "
...
#define IMPLEMENT_STATELESS(name)                                              \
  static PyObject *TH_CONCAT_2(THPModule_, name)(                              \
      PyObject * _unused, PyObject * args, PyObject * kwargs) {                \
...
// For logical functions a reverse type search is required (if the first
// argument
...
PyObject *THPModule_safeCall(PyObject *_unused, PyObject *args,
                             PyObject *kwargs) {
...
PyObject *THPModule_inferSize(PyObject *_unused, PyObject *args) {
  ...
  int ret =
      THLongStorage_inferSize2(sizes, size1->data, size1->size, size2->data,
                               size2->size, error_buffer, 1024);
  THPUtils_assert(ret == 0, error_buffer);
  return THPSize_New(sizes->size, sizes->data);
  END_HANDLE_TH_ERRORS
}

static PyObject *THPModule_setBackcompatBroadcastWarn(PyObject *module,
                                                      PyObject *arg) {
  THPUtils_assert(PyBool_Check(arg),
...
static PyObject *THPModule_setBackcompatKeepdimWarn(PyObject *module,
                                                    PyObject *arg) {
  THPUtils_assert(PyBool_Check(arg),
...
extern PyObject *THCPModule_setRNGState(PyObject *_unused,
                                        PyObject *_new_rng_state);
...
static PyMethodDef TorchMethods[] = {
    ...
    {"_autograd_init", (PyCFunction)THPAutograd_initExtension, METH_NOARGS,
     NULL},
    ...
    {"_has_distributed", (PyCFunction)THPModule_hasDistributed, METH_NOARGS,
     NULL},
#ifdef WITH_CUDA
    ...
    {"_cuda_getDevice", (PyCFunction)THCPModule_getDevice_wrap, METH_NOARGS,
     NULL},
    {"_cuda_getDeviceCount", (PyCFunction)THCPModule_getDeviceCount_wrap,
     METH_NOARGS, NULL},
    {"_cuda_getDeviceName", (PyCFunction)THCPModule_getDeviceName_wrap, METH_O,
     NULL},
    {"_cuda_getCurrentStream", (PyCFunction)THCPModule_getCurrentStream_wrap,
     METH_NOARGS, NULL},
    {"_cuda_getCurrentBlasHandle",
     (PyCFunction)THCPModule_getCurrentBlasHandle_wrap, METH_NOARGS, NULL},
    {"_cuda_setStream", (PyCFunction)THCPModule_setStream_wrap, METH_O, NULL},
    {"_cuda_isDriverSufficient", (PyCFunction)THCPModule_isDriverSufficient,
     METH_NOARGS, NULL},
    {"_cuda_getDriverVersion", (PyCFunction)THCPModule_getDriverVersion,
     METH_NOARGS, NULL},
    ...
    {"_cuda_initialSeed", (PyCFunction)THCPModule_initialSeed, METH_NOARGS,
     NULL},
    {"_cuda_cudaHostAllocator", (PyCFunction)THCPModule_cudaHostAllocator,
     METH_NOARGS, NULL},
    ...
    {"_cuda_sparse_init", (PyCFunction)THCSPModule_initExtension, METH_NOARGS,
     NULL},
    ...
    {"_cuda_unlock_mutex", (PyCFunction)THCPModule_cudaUnlockMutex, METH_NOARGS,
     NULL},
#endif
    {"_safe_call", (PyCFunction)THPModule_safeCall,
     METH_VARARGS | METH_KEYWORDS, NULL},
    {"_set_default_tensor_type", (PyCFunction)THPModule_setDefaultTensorType,
     METH_O, NULL},
    {"_infer_size", (PyCFunction)THPModule_inferSize, METH_VARARGS, NULL},
    {"_set_backcompat_broadcast_warn",
     (PyCFunction)THPModule_setBackcompatBroadcastWarn, METH_O, NULL},
    {"_get_backcompat_broadcast_warn",
     (PyCFunction)THPModule_getBackcompatBroadcastWarn, METH_NOARGS, NULL},
    {"_set_backcompat_keepdim_warn",
     (PyCFunction)THPModule_setBackcompatKeepdimWarn, METH_O, NULL},
    {"_get_backcompat_keepdim_warn",
     (PyCFunction)THPModule_getBackcompatKeepdimWarn, METH_NOARGS, NULL},
    {"get_num_threads", (PyCFunction)THPModule_getNumThreads, METH_NOARGS,
     NULL},
    {"set_num_threads", (PyCFunction)THPModule_setNumThreads, METH_O, NULL},
    {"from_numpy", (PyCFunction)THPModule_fromNumpy, METH_O, NULL},

    {"sigmoid", (PyCFunction)THPModule_sigmoid, METH_VARARGS | METH_KEYWORDS,
     NULL},
    ...
    {"lgamma", (PyCFunction)THPModule_lgamma, METH_VARARGS | METH_KEYWORDS,
     NULL},
    {"erf", (PyCFunction)THPModule_erf, METH_VARARGS | METH_KEYWORDS, NULL},
    {"erfinv", (PyCFunction)THPModule_erfinv, METH_VARARGS | METH_KEYWORDS,
     NULL},
    ...
    {"reciprocal", (PyCFunction)THPModule_reciprocal,
     METH_VARARGS | METH_KEYWORDS, NULL},
    ...
    {"remainder", (PyCFunction)THPModule_remainder,
     METH_VARARGS | METH_KEYWORDS, NULL},
    {"cumsum", (PyCFunction)THPModule_cumsum, METH_VARARGS | METH_KEYWORDS,
     NULL},
    {"cumprod", (PyCFunction)THPModule_cumprod, METH_VARARGS | METH_KEYWORDS,
     NULL},
    ...
    {"kthvalue", (PyCFunction)THPModule_kthvalue, METH_VARARGS | METH_KEYWORDS,
     NULL},
    {"mode", (PyCFunction)THPModule_mode, METH_VARARGS | METH_KEYWORDS, NULL},
    {"median", (PyCFunction)THPModule_median, METH_VARARGS | METH_KEYWORDS,
     NULL},
    ...
    {"transpose", (PyCFunction)THPModule_transpose,
     METH_VARARGS | METH_KEYWORDS, NULL},
    {"squeeze", (PyCFunction)THPModule_squeeze, METH_VARARGS | METH_KEYWORDS,
     NULL},
    {"unsqueeze", (PyCFunction)THPModule_unsqueeze,
     METH_VARARGS | METH_KEYWORDS, NULL},
    {"nonzero", (PyCFunction)THPModule_nonzero, METH_VARARGS | METH_KEYWORDS,
     NULL},
    {"renorm", (PyCFunction)THPModule_renorm, METH_VARARGS | METH_KEYWORDS,
     NULL},
    {"dist", (PyCFunction)THPModule_dist, METH_VARARGS | METH_KEYWORDS, NULL},
    {"linspace", (PyCFunction)THPModule_linspace, METH_VARARGS | METH_KEYWORDS,
     NULL},
    {"logspace", (PyCFunction)THPModule_logspace, METH_VARARGS | METH_KEYWORDS,
     NULL},
    ...
    {"zeros_like", (PyCFunction)THPModule_zeros_like,
     METH_VARARGS | METH_KEYWORDS, NULL},
    {"ones", (PyCFunction)THPModule_ones, METH_VARARGS | METH_KEYWORDS, NULL},
    {"ones_like", (PyCFunction)THPModule_ones_like,
     METH_VARARGS | METH_KEYWORDS, NULL},
    {"index_select", (PyCFunction)THPModule_index_select,
     METH_VARARGS | METH_KEYWORDS, NULL},
    ...
    {"addbmm", (PyCFunction)THPModule_addbmm, METH_VARARGS | METH_KEYWORDS,
     NULL},
    {"baddbmm", (PyCFunction)THPModule_baddbmm, METH_VARARGS | METH_KEYWORDS,
     NULL},
    {"addcmul", (PyCFunction)THPModule_addcmul, METH_VARARGS | METH_KEYWORDS,
     NULL},
    {"addcdiv", (PyCFunction)THPModule_addcdiv, METH_VARARGS | METH_KEYWORDS,
     NULL},
    {"mm", (PyCFunction)THPModule_mm, METH_VARARGS | METH_KEYWORDS, NULL},
    {"bmm", (PyCFunction)THPModule_bmm, METH_VARARGS | METH_KEYWORDS, NULL},
    {"multinomial", (PyCFunction)THPModule_multinomial,
     METH_VARARGS | METH_KEYWORDS, NULL},
    {"normal", (PyCFunction)THPModule_normal, METH_VARARGS | METH_KEYWORDS,
     NULL},
    {"bernoulli", (PyCFunction)THPModule_bernoulli,
     METH_VARARGS | METH_KEYWORDS, NULL},
    ...
    {"randperm", (PyCFunction)THPModule_randperm, METH_VARARGS | METH_KEYWORDS,
     NULL},
    {"range", (PyCFunction)THPModule_range, METH_VARARGS | METH_KEYWORDS, NULL},
    {"arange", (PyCFunction)THPModule_arange, METH_VARARGS | METH_KEYWORDS,
     NULL},
    {"gather", (PyCFunction)THPModule_gather, METH_VARARGS | METH_KEYWORDS,
     NULL},
    {"cat", (PyCFunction)THPModule_cat, METH_VARARGS | METH_KEYWORDS, NULL},
    {"masked_select", (PyCFunction)THPModule_masked_select,
     METH_VARARGS | METH_KEYWORDS, NULL},
    ...
    {"symeig", (PyCFunction)THPModule_symeig, METH_VARARGS | METH_KEYWORDS,
     NULL},
    ...
    {"inverse", (PyCFunction)THPModule_inverse, METH_VARARGS | METH_KEYWORDS,
     NULL},
    ...
    {"btrifact", (PyCFunction)THPModule_btrifact, METH_VARARGS | METH_KEYWORDS,
     NULL},
    {"btrisolve", (PyCFunction)THPModule_btrisolve,
     METH_VARARGS | METH_KEYWORDS, NULL},

    // Sparse functions
    {"smm", (PyCFunction)THSPModule_sspmm, METH_VARARGS | METH_KEYWORDS, NULL},
    {"saddmm", (PyCFunction)THSPModule_sspaddmm, METH_VARARGS | METH_KEYWORDS,
     NULL},
...
bool THDPZDoubleStorage_init(PyObject *module);
bool THDPZFloatStorage_init(PyObject *module);
...
bool THDPZDoubleTensor_init(PyObject *module);
bool THDPZFloatTensor_init(PyObject *module);
...
#define ASSERT_TRUE(cmd)                                                       \
  if (!(cmd)) {                                                                \
    PyErr_SetString(PyExc_ImportError, "initialization error");                \
    return;                                                                    \
  }
#else
#define ASSERT_TRUE(cmd)                                                       \
...
#else
  static struct PyModuleDef torchmodule = {PyModuleDef_HEAD_INIT, "torch._C",
                                           NULL, -1, methods.data()};
  ...
  ASSERT_TRUE(THPZDoubleStorage_init(module));
  ASSERT_TRUE(THPZFloatStorage_init(module));
  ...
  ASSERT_TRUE(THPZDoubleTensor_init(module));
  ASSERT_TRUE(THPZFloatTensor_init(module));
  ...
  ASSERT_TRUE(THSPZDoubleTensor_init(module));
  ASSERT_TRUE(THSPZFloatTensor_init(module));
...
// PyErr_WarnEx(PyExc_Warning, "after THSPZFloatTensor_init", 1);
  ...
  // ASSERT_TRUE(THCSPZDoubleTensor_init(module));
  // ASSERT_TRUE(THCSPZFloatTensor_init(module));
...
// PyErr_WarnEx(PyExc_Warning, "after THCPZFloatTensor_init", 1);
#endif
  ...
  ASSERT_TRUE(THDPZDoubleStorage_init(module));
  ASSERT_TRUE(THDPZFloatStorage_init(module));
  ...
  ASSERT_TRUE(THDPZDoubleTensor_init(module));
  ASSERT_TRUE(THDPZFloatTensor_init(module));
...
// PyErr_WarnEx(PyExc_Warning, "after THDPFloatTensor_init", 1);
#endif

  THPDefaultGenerator = (THPGenerator *)THPGenerator_New();
  ASSERT_TRUE(THPDefaultGenerator != nullptr);
  ASSERT_TRUE(PyModule_AddObject(module, "default_generator",
                                 (PyObject *)THPDefaultGenerator) == 0);

  // force ATen to initialize because it handles
  // setting up TH Errors so that they throw C++ exceptions
  at::init();
// PyErr_WarnEx(PyExc_Warning, "after at::init()", 1);
#ifdef WITH_NUMPY
  import_array();
#endif
