...
IMPLEMENT_THFILE_RW(ZFloat, float _Complex)
IMPLEMENT_THFILE_RW(ZDouble, double _Complex)
...
IMPLEMENT_THFILE_SCALAR(ZFloat, float _Complex)
IMPLEMENT_THFILE_SCALAR(ZDouble, double _Complex)
...
IMPLEMENT_THFILE_STORAGE(ZFloat, float _Complex)
IMPLEMENT_THFILE_STORAGE(ZDouble, double _Complex)
