...
IMPLEMENT_THFILE_RW(ZFloat, cx)
IMPLEMENT_THFILE_RW(ZDouble, zx)
...
IMPLEMENT_THFILE_SCALAR(ZFloat, cx)
IMPLEMENT_THFILE_SCALAR(ZDouble, zx)
...
IMPLEMENT_THFILE_STORAGE(ZFloat, cx)
IMPLEMENT_THFILE_STORAGE(ZDouble, zx)
