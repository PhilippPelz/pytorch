...
void THVector_(cadd_DEFAULT)(real *z, const real *x, const real *y,
                             const real c, const ptrdiff_t n) {
  ptrdiff_t i = 0;
...
void THVector_(adds_DEFAULT)(real *y, const real *x, const real c,
                             const ptrdiff_t n) {
  ptrdiff_t i = 0;
...
void THVector_(cmul_DEFAULT)(real *z, const real *x, const real *y,
                             const ptrdiff_t n) {
  ptrdiff_t i = 0;
...
void THVector_(muls_DEFAULT)(real *y, const real *x, const real c,
                             const ptrdiff_t n) {
  ptrdiff_t i = 0;
...
void THVector_(cdiv_DEFAULT)(real *z, const real *x, const real *y,
                             const ptrdiff_t n) {
  ptrdiff_t i = 0;
...
void THVector_(divs_DEFAULT)(real *y, const real *x, const real c,
                             const ptrdiff_t n) {
  ptrdiff_t i = 0;
...
#define VECTOR_IMPLEMENT_ZFUNCTION(NAME, CFUNC)                                \
  void THVector_(z##NAME)(part * y, const real *x, const ptrdiff_t n) {        \
    ptrdiff_t i = 0;                                                           \
    for (; i < n - 4; i += 4) {                                                \
      y[i] = CFUNC(x[i]);                                                      \
      y[i + 1] = CFUNC(x[i + 1]);                                              \
...
#define VECTOR_IMPLEMENT_FUNCTION_VALUE(NAME, CFUNC)                           \
  void THVector_(NAME)(real * y, const real *x, const real c,                  \
                       const ptrdiff_t n) {                                    \
    ptrdiff_t i = 0;                                                           \
    for (; i < n - 4; i += 4) {                                                \
      y[i] = CFUNC(x[i], c);                                                   \
...
void THVector_(log10)(real *y, const real *x, const ptrdiff_t n) {
  ptrdiff_t i = 0;
  for (; i < n - 4; i += 4) {
    y[i] = TH_MATH_NAME(log)(x[i]) / TH_MATH_NAME(log)(10);
    y[i + 1] = TH_MATH_NAME(log)(x[i + 1]) / TH_MATH_NAME(log)(10);
    y[i + 2] = TH_MATH_NAME(log)(x[i + 2]) / TH_MATH_NAME(log)(10);
    y[i + 3] = TH_MATH_NAME(log)(x[i + 3]) / TH_MATH_NAME(log)(10);
  }
  for (; i < n; i++)
    y[i] = TH_MATH_NAME(log)(x[i]) / TH_MATH_NAME(log)(10);
}
...
VECTOR_IMPLEMENT_FUNCTION(zabs, TH_MATH_NAME(fabs))
#else

VECTOR_IMPLEMENT_FUNCTION(abs, CABS)
VECTOR_IMPLEMENT_FUNCTION(arg, CARG)
VECTOR_IMPLEMENT_FUNCTION(re, CREAL)
VECTOR_IMPLEMENT_FUNCTION(im, CIMAG)
VECTOR_IMPLEMENT_FUNCTION(conj, CONJ)

VECTOR_IMPLEMENT_ZFUNCTION(abs, CABS)
VECTOR_IMPLEMENT_ZFUNCTION(arg, CARG)
VECTOR_IMPLEMENT_ZFUNCTION(re, CREAL)
VECTOR_IMPLEMENT_ZFUNCTION(im, CIMAG)
VECTOR_IMPLEMENT_ZFUNCTION(conj, CONJ)
#endif
