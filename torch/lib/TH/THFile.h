...
TH_API cx THFile_readZFloatScalar(THFile *self);
TH_API zx THFile_readZDoubleScalar(THFile *self);
...
TH_API void THFile_writeZFloatScalar(THFile *self, cx scalar);
TH_API void THFile_writeZDoubleScalar(THFile *self, zx scalar);
...
TH_API size_t THFile_readZFloatRaw(THFile *self, cx *data, size_t n);
TH_API size_t THFile_readZDoubleRaw(THFile *self, zx *data, size_t n);
...
TH_API size_t THFile_writeZFloatRaw(THFile *self, cx *data, size_t n);
TH_API size_t THFile_writeZDoubleRaw(THFile *self, zx *data, size_t n);
