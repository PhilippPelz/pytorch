...
TH_API float _Complex THFile_readZFloatScalar(THFile *self);
TH_API double _Complex THFile_readZDoubleScalar(THFile *self);
...
TH_API void THFile_writeZFloatScalar(THFile *self, float _Complex scalar);
TH_API void THFile_writeZDoubleScalar(THFile *self, double _Complex scalar);
...
TH_API size_t THFile_readZFloat(THFile *self, THZFloatStorage *storage);
TH_API size_t THFile_readZDouble(THFile *self, THZDoubleStorage *storage);
...
TH_API size_t THFile_writeZFloat(THFile *self, THZFloatStorage *storage);
TH_API size_t THFile_writeZDouble(THFile *self, THZDoubleStorage *storage);
...
TH_API size_t THFile_readZFloatRaw(THFile *self, float _Complex *data, size_t n);
TH_API size_t THFile_readZDoubleRaw(THFile *self, double _Complex *data, size_t n);
...
TH_API size_t THFile_writeZFloatRaw(THFile *self, float _Complex *data, size_t n);
TH_API size_t THFile_writeZDoubleRaw(THFile *self, double _Complex *data, size_t n);
