...
THC_API double THCudaBlas_Ddot(THCState *state, long n, double *x, long incx,
                               double *y, long incy);
THC_API ccx THCudaBlas_Cdot(THCState *state, long n,
                                       ccx *x, long incx,
                                       ccx *y, long incy);
THC_API zcx THCudaBlas_Zdot(THCState *state, long n,
                                        zcx *x, long incx,
                                        zcx *y, long incy);
...
THC_API void THCudaBlas_Dger(THCState *state, long m, long n, double alpha,
                             ...
                             double *a, long lda);
THC_API void THCudaBlas_Cger(THCState *state, long m, long n, ccx alpha,
                             ccx *x, long incx, ccx *y, long incy,
                             ccx *a, long lda);
THC_API void THCudaBlas_Zger(THCState *state, long m, long n,
                             zcx alpha, zcx *x,
...
THC_API void THCudaBlas_Cgetrf(THCState *state, int n, ccx **a, int lda,
                               int *pivot, int *info, int batchSize);
THC_API void THCudaBlas_Zgetrf(THCState *state, int n, zcx **a,
...
THC_API void THCudaBlas_Cgetri(THCState *state, int n, const ccx **a,
                               int lda, int *pivot, ccx **c, int ldc,
                               int *info, int batchSize);
THC_API void THCudaBlas_Zgetri(THCState *state, int n,
                               const zcx **a, int lda, int *pivot,
