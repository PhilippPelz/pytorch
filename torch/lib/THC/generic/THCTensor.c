...
THCTensor *THCTensor_(newWithStorage1d)(THCState *state, THCStorage *storage,
                                        ptrdiff_t storageOffset, long size0,
                                        long stride0) {
...
THCTensor *THCTensor_(newWithStorage3d)(THCState *state, THCStorage *storage,
                                        ptrdiff_t storageOffset, long size0,
                                        long stride0, long size1, long stride1,
...
THCTensor *THCTensor_(newWithStorage4d)(THCState *state, THCStorage *storage,
                                        ptrdiff_t storageOffset, long size0,
                                        long stride0, long size1, long stride1,
                                        long size2, long stride2, long size3,
                                        long stride3) {
  ...
  THCTensor *self = (THCTensor *)THAlloc(sizeof(THCTensor));
  THCTensor_(rawInit)(state, self);
  THCTensor_(setStorageNd)(state, self, storage, storageOffset, 4, size,
                           stride);
...
THCTensor *THCTensor_(newWithSize3d)(THCState *state, long size0, long size1,
                                     long size2) {
  return THCTensor_(newWithSize4d)(state, size0, size1, size2, -1);
}

THCTensor *THCTensor_(newWithSize4d)(THCState *state, long size0, long size1,
                                     long size2, long size3) {
  long size[4] = {size0, size1, size2, size3};
...
void THCTensor_(resize2d)(THCState *state, THCTensor *tensor, long size0,
                          long size1) {
  THCTensor_(resize4d)(state, tensor, size0, size1, -1, -1);
}

void THCTensor_(resize3d)(THCState *state, THCTensor *tensor, long size0,
                          long size1, long size2) {
  THCTensor_(resize4d)(state, tensor, size0, size1, size2, -1);
}

void THCTensor_(resize4d)(THCState *state, THCTensor *self, long size0,
...
void THCTensor_(resize5d)(THCState *state, THCTensor *self, long size0,
...
void THCTensor_(narrow)(THCState *state, THCTensor *self, THCTensor *src,
                        int dimension, long firstIndex, long size) {
  if (!src)
    src = self;
...
void THCTensor_(unsqueeze1d)(THCState *state, THCTensor *self, THCTensor *src,
  ...
  self->size =
      (long *)THRealloc(self->size, sizeof(long) * (self->nDimension + 1));
  self->stride =
...
void THCTensor_(set1d)(THCState *state, THCTensor *tensor, long x0,
                       real value) {
...
void THCTensor_(set2d)(THCState *state, THCTensor *tensor, long x0, long x1,
                       real value) {
...
real THCTensor_(get2d)(THCState *state, const THCTensor *tensor, long x0,
                       long x1) {
  THArgCheck(tensor->nDimension == 2, 1, "tensor must have two dimensions");
  THArgCheck((x0 >= 0) && (x0 < tensor->size[0]) && (x1 >= 0) &&
                 (x1 < tensor->size[1]),
...
void THCTensor_(set3d)(THCState *state, THCTensor *tensor, long x0, long x1,
                       long x2, real value) {
...
real THCTensor_(get3d)(THCState *state, const THCTensor *tensor, long x0,
                       long x1, long x2) {
  THArgCheck(tensor->nDimension == 3, 1, "tensor must have three dimensions");
  THArgCheck((x0 >= 0) && (x0 < tensor->size[0]) && (x1 >= 0) &&
                 (x1 < tensor->size[1]) && (x2 >= 0) && (x2 < tensor->size[2]),
...
void THCTensor_(set4d)(THCState *state, THCTensor *tensor, long x0, long x1,
...
real THCTensor_(get4d)(THCState *state, const THCTensor *tensor, long x0,
