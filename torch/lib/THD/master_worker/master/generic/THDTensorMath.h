...
THD_API void THDTensor_(maskedFill)(THDTensor *tensor, THDByteTensor *mask,
                                    real value);
THD_API void THDTensor_(maskedCopy)(THDTensor *tensor, THDByteTensor *mask,
                                    THDTensor *src);
THD_API void THDTensor_(maskedSelect)(THDTensor *tensor, THDTensor *src,
                                      THDByteTensor *mask);
...
THD_API void THDTensor_(indexSelect)(THDTensor *tensor, THDTensor *src, int dim,
                                     THDLongTensor *index);
THD_API void THDTensor_(indexCopy)(THDTensor *tensor, int dim,
                                   THDLongTensor *index, THDTensor *src);
THD_API void THDTensor_(indexAdd)(THDTensor *tensor, int dim,
                                  THDLongTensor *index, THDTensor *src);
THD_API void THDTensor_(indexFill)(THDTensor *tensor, int dim,
                                   THDLongTensor *index, real val);
...
THD_API void THDTensor_(range)(THDTensor *r_, accreal xmin, accreal xmax,
                               accreal step);
THD_API void THDTensor_(randperm)(THDTensor *r_, THDGenerator *_generator,
                                  int64_t n);
THD_API void THDTensor_(reshape)(THDTensor *r_, THDTensor *t,
                                 THDLongStorage *size);
THD_API void THDTensor_(sort)(THDTensor *rt_, THDLongTensor *ri_, THDTensor *t,
                              int dimension, int descendingOrder);
THD_API void THDTensor_(topk)(THDTensor *rt_, THDLongTensor *ri_, THDTensor *t,
...
THD_API void THDTensor_(cat)(THDTensor *r_, THDTensor *ta, THDTensor *tb,
                             int dimension);
...
THD_API void THDTensor_(ltTensor)(THDByteTensor *r_, THDTensor *ta,
                                  THDTensor *tb);
THD_API void THDTensor_(leTensor)(THDByteTensor *r_, THDTensor *ta,
                                  THDTensor *tb);
THD_API void THDTensor_(gtTensor)(THDByteTensor *r_, THDTensor *ta,
                                  THDTensor *tb);
THD_API void THDTensor_(geTensor)(THDByteTensor *r_, THDTensor *ta,
                                  THDTensor *tb);
THD_API void THDTensor_(neTensor)(THDByteTensor *r_, THDTensor *ta,
                                  THDTensor *tb);
THD_API void THDTensor_(eqTensor)(THDByteTensor *r_, THDTensor *ta,
                                  THDTensor *tb);
...
THD_API void THDTensor_(lerp)(THDTensor *r_, THDTensor *a, THDTensor *b,
                              real weight);
THD_API void THDTensor_(mean)(THDTensor *r_, THDTensor *t, int dimension,
                              int keepdim);
THD_API void THDTensor_(std)(THDTensor *r_, THDTensor *t, int dimension,
                             int biased, int keepdim);
THD_API void THDTensor_(var)(THDTensor *r_, THDTensor *t, int dimension,
                             int biased, int keepdim);
...
THD_API void THDTensor_(histc)(THDTensor *hist, THDTensor *tensor,
                               int64_t nbins, real minvalue, real maxvalue);
THD_API void THDTensor_(bhistc)(THDTensor *hist, THDTensor *tensor,
                                int64_t nbins, real minvalue, real maxvalue);
